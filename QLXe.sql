...
INSERT INTO LoaiXe 
VALUES 
(N'Mini hay Hatchback'),
(N'Sedan, xe du lịch 4 chỗ'),
(N'Coupe hay Sport Car'),
(N'SUV 5 chỗ hay Crossover'),
(N'MPV hay Minivan'),
(N'Pickup hay xe bán tải'),
(N'SUV 7 chỗ')
GO
...
INSERT INTO Xe 
VALUES 
(N'HYUNDAI I10','2000',330000000,0),
(N'KIA MORNING','2000',299000000,1),
(N'VINFAST FADIL','2000',414000000,2),
(N'SUZUKI CELERIO','2000',329000000,3),
(N'TOYOTA VIOS','2000',470000000,4),
(N'SUZUKI ERTIGA','2000',499000000,5),
(N'KIA SOLUTO','2000',399000000,6)
GO

INSERT INTO HoaDon 
VALUES 
('05/10/2016','399000000',4),
('04/24/2018','414000000',3),
('06/24/2018','499000000',2),
('10/17/2017','199000000',1),
('03/17/2016','299000000',0)
GO
